...
{
    public class AccountHeadTypeController : Controller
    {
        #region Fields
        ...
        public AccountHeadTypeController(IMediator mediator, ILogger<AccountHeadTypeController> logger)
        {
            _mediator = mediator;
            _logger = logger;
        }
        ...
        // GET: AccountHeadType/AccountHeadType-List
        [HttpGet]
        public async Task<IActionResult> AccountHeadTypeList(string search = "", int page = 1, int pageSize = 10, string sortField = "AccountHeadTypeName", string sortOrder = "asc")
        {
        ...
        // GET: AccountHeadType/AccountHeadType-View
        [HttpGet]
        public async Task<IActionResult> AccountHeadTypeView()
        {
            var companies = await _mediator.Send(new GetCompaniesQuery());
        ...
        //POST: AccountHeadType/AccountHeadType-View     
        [HttpPost]
